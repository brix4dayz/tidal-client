...
var m=a.length/240
e.textAlign="right"
for(var u=0;m>u;u+=.5)e.beginPath(),e.moveTo(50+u*i/m,n),e.lineTo(55+u*i/m,n+15),e.stroke(),u%1==0?e.fillText("12AM",90+u*i/m,n+30):e.fillText("Noon",90+u*i/m,n+30)}}const SERVER="http://45.33.68.196:8000"
