...
TidePull.labelAxis(e,l,i,o,r,t,n,d,a,u)},TidePull.labelAxis=function(e,l,i,t,a,d,n,o,r,u){e.fillStyle="#092643",e.textAlign="left",e.font=TidePull.labelFont1+"px Sans Serif",e.fillText("Tides in Feet",TidePull.leftMarg+5,.8*TidePull.topMarg),e.font=TidePull.labelFont2+"px Sans Serif",e.textAlign="right",e.strokeStyle="black",e.lineWidth=1
...
TidePull.timeAxis(e,l,r,o,i,d)},TidePull.highLow=function(e,l){for(var i=l[0],t=i,a=0;a<l.length;a++)l[a].pred>i.pred&&(i=l[a]),l[a].pred<t.pred&&(t=l[a])
var d=JSON.stringify(i.timeStamp),n=JSON.stringify(t.timeStamp),o="High: "+i.pred+" at "+d.slice(13,18)+"  Low: "+t.pred+" at "+n.slice(13,18)
e.textAlign="right",e.fillStyle="#092643",e.font=TidePull.labelFont1+"px Sans Serif",e.fillText(o,TidePull.leftMarg+TidePull.chartWidth,.8*TidePull.topMarg)},TidePull.timeAxis=function(e,l,i,t,a,d){if(240==a.length){e.font=TidePull.timeFont+"px Sans Serif",e.strokeStyle="#092643",e.fillStyle="#092643",e.textAlign="center"
for(var n=1;12>n;n++)e.beginPath(),e.moveTo(TidePull.leftMarg+n*i/12,t),e.lineTo(TidePull.leftMarg+.1*TidePull.leftMarg+n*i/12,t+.3*TidePull.topMarg),e.stroke(),e.closePath(),e.beginPath(),e.arc(TidePull.leftMarg+n*i/12,t,3,0,2*Math.PI,!0),e.closePath(),e.fill(),e.beginPath(),e.moveTo(TidePull.leftMarg+n*i/12,TidePull.topMarg),e.lineTo(TidePull.leftMarg+n*i/12,TidePull.topMarg+d),e.stroke(),e.closePath(),6>n?e.fillText(2*n+"AM",1.6*TidePull.leftMarg+n*i/12,t+.8*TidePull.topMarg):6==n?e.fillText(2*n+"PM",1.6*TidePull.leftMarg+n*i/12,t+.8*TidePull.topMarg):e.fillText(n%6*2+"PM",1.6*TidePull.leftMarg+n*i/12,t+.8*TidePull.topMarg)}else{e.font=TidePull.timeFont+1+"px Sans Serif",e.fillStyle="#092643"
var o=a.length/240
