...
window.TidePull.totalTime=0,window.TidePull.updateDeltaTime=e,window.TidePull.resetTime=l}(),TidePull.getCanvas=function(){TidePull.first&&(TidePull.first=!1,TidePull.resetTime()),TidePull.updateDeltaTime(),TidePull.stop?(TidePull.tideData=null,TidePull.options=null):(requestAnimationFrame(TidePull.getCanvas),TidePull.getMax(TidePull.context,TidePull.options,TidePull.tideData))},TidePull.getMax=function(e,l,t){var a=.5,n=-.5
for(i in t)t[i].pred>a&&(a=Math.round(2*t[i].pred)/2+.5),t[i].pred<n&&(n=Math.round(2*t[i].pred)/2-.5)
TidePull.drawAxis(e,l,t,a,n)},TidePull.drawAxis=function(e,l,i,t,a){var n=(t-a)/.25,d=.25
e.clearRect(0,0,TidePull.clearWidth,TidePull.clearHeight),n>20&&(n=.5*n,d=.5)
for(var o=0;n>o;o++)o%2==0?e.fillStyle="#e8f8ff":e.fillStyle="#fbfdfb",e.fillRect(TidePull.leftMarg+1,o*TidePull.chartHeight/n+TidePull.topMarg,TidePull.chartWidth,TidePull.chartHeight/n)
var r=TidePull.chartHeight*t/(n*d)+TidePull.topMarg
e.beginPath(),e.moveTo(TidePull.leftMarg,TidePull.topMarg),e.lineTo(TidePull.leftMarg,TidePull.chartHeight+TidePull.topMarg),e.moveTo(TidePull.leftMarg,r),e.lineTo(TidePull.chartWidth+TidePull.leftMarg,r),e.lineWidth=2,e.strokeStyle="#092643",e.stroke(),TidePull.plotData(e,l,i,TidePull.chartHeight,TidePull.chartWidth,r,n,t,a,d)},TidePull.plotData=function(e,l,i,t,a,n,d,o,r,u){console.log("Plotting.")
var s=TidePull.totalTime/TidePull.PLOT_TIME
s>=1&&(s=1,TidePull.stop=!0,console.log("Should stop."))
var c=s*i.length,p=i.length
e.strokeStyle="black",e.lineWidth=.1,e.beginPath(),e.moveTo(TidePull.leftMarg+1,n-i[0].pred*t/(d*u)),j=0,e.fillStyle="#a0abb6"
for(var T=0;c>T;T++)e.lineTo(a/p*j+TidePull.leftMarg+1,n-i[T].pred*t/(d*u)),e.stroke(),e.fillRect(a/p*j+TidePull.leftMarg+1,n-i[T].pred*t/(d*u),1,i[T].pred*t/(d*u)-1),j++
TidePull.labelAxis(e,l,i,o,r,t,d,n,a,u)},TidePull.labelAxis=function(e,l,i,t,a,n,d,o,r,u){e.fillStyle="#092643",e.font=TidePull.labelFont1+"px Sans Serif",e.fillText("Tides in Feet",2.5*TidePull.leftMarg,.8*TidePull.topMarg),e.font=TidePull.labelFont2+"px Sans Serif",d>15&&(e.font=TidePull.labelFont2-2+"px Sans Serif"),e.textAlign="right",e.strokeStyle="black",e.lineWidth=1
for(var s=0;t>=s;s+=u)e.fillText(s,TidePull.leftMarg-TidePull.Yfact,o-s*n/(d*u)+.2*TidePull.topMarg),e.beginPath(),e.moveTo(TidePull.leftMarg,o-s*n/(d*u)),e.lineTo(TidePull.leftMarg+TidePull.chartWidth,o-s*n/(d*u)),e.stroke()
for(var c=a;0>c;c+=u)e.fillText(c,TidePull.leftMarg-TidePull.Yfact,o-c*n/(d*u)+2),e.beginPath(),e.moveTo(TidePull.leftMarg,o-c*n/(d*u)),e.lineTo(TidePull.leftMarg+TidePull.chartWidth,o-c*n/(d*u)),e.stroke()
...
for(var d=1;12>d;d++)e.beginPath(),e.moveTo(TidePull.leftMarg+d*i/12,t),e.lineTo(TidePull.leftMarg+.1*TidePull.leftMarg+d*i/12,t+.3*TidePull.topMarg),e.stroke(),e.closePath(),e.beginPath(),e.arc(TidePull.leftMarg+d*i/12,t,3,0,2*Math.PI,!0),e.closePath(),e.fill(),e.beginPath(),e.moveTo(TidePull.leftMarg+d*i/12,TidePull.topMarg),e.lineTo(TidePull.leftMarg+d*i/12,TidePull.topMarg+n),e.stroke(),e.closePath(),6>d?e.fillText(2*d+"AM",1.6*TidePull.leftMarg+d*i/12,t+.8*TidePull.topMarg):6==d?e.fillText(2*d+"PM",1.6*TidePull.leftMarg+d*i/12,t+.8*TidePull.topMarg):e.fillText(d%6*2+"PM",1.6*TidePull.leftMarg+d*i/12,t+.8*TidePull.topMarg)}else{e.font=TidePull.timeFont+1+"px Sans Serif",e.fillStyle="#092643"
var o=a.length/240
e.textAlign="center",e.fillText("(Vertical lines mark every six hours)",TidePull.leftMarg+6*TidePull.leftMarg,.8*TidePull.topMarg),e.font="bold "+(TidePull.timeFont+1)+"px Sans Serif"
for(var r=0;o>r;r+=.25)r%.5==0&&(e.beginPath(),e.moveTo(TidePull.leftMarg+r*i/o,t),e.lineTo(TidePull.leftMarg+.1*TidePull.leftMarg+r*i/o,t+.3*TidePull.topMarg),e.stroke(),e.closePath(),e.beginPath(),e.arc(TidePull.leftMarg+r*i/o,t,3,0,2*Math.PI,!0),e.closePath(),e.fill()),e.beginPath(),e.moveTo(TidePull.leftMarg+r*i/o,TidePull.topMarg),e.lineTo(TidePull.leftMarg+r*i/o,TidePull.topMarg+TidePull.chartHeight),e.stroke(),e.closePath(),r%1==0?(e.fillText("12AM",1.5*TidePull.leftMarg+r*i/o,t+.8*TidePull.topMarg),0!=r&&e.fillText("Day"+(r+1),1.4*TidePull.leftMarg+r*i/o,t-.3*TidePull.topMarg)):r%.5==0&&r%1!=0&&e.fillText("Noon",1.6*TidePull.leftMarg+r*i/o,t+.8*TidePull.topMarg)}e.beginPath(),e.moveTo(TidePull.leftMarg+TidePull.chartWidth,TidePull.topMarg),e.lineTo(TidePull.leftMarg+TidePull.chartWidth,TidePull.topMarg+TidePull.chartHeight),e.stroke(),e.closePath()},$("body").append('  <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBpN0l_qaCwhVFOKjFIHDuEgtlOkrlFixQ&signed_in=true&callback=map">  </script>')
