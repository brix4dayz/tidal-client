...
e&&(TidePull.alerts.innerHTML="",TidePull.requestTides(),$("#map").hide(),$("#plotter").show(),$("#returnBtn").show(300))}else TidePull.alerts.innerHTML=TidePull.alertArray[3]}),$("#returnBtn").on("click",function(){$("#map").show(),$("#plotter").hide(),$("#returnBtn").hide(300)}),$(function(){$("#datepickerA").datepicker()}),$(function(){$("#datepickerB").datepicker()}),$(function(){$("#datepickerC").datepicker()}),TidePull.mobile?(TidePull.chartHeight=225,TidePull.chartWidth=280):(TidePull.chartHeight=365,TidePull.chartWidth=490),TidePull.leftMarg=.0714*TidePull.chartWidth,TidePull.topMarg=TidePull.chartHeight/18,TidePull.clearHeight=TidePull.chartHeight+TidePull.topMarg,TidePull.clearWidth=TidePull.chartWidth+TidePull.leftMarg,function(){for(var e=0,l=["ms","moz","webkit","o",""],i=0;i<l.length&&!window.requestAnimationFrame;++i)window.requestAnimationFrame=window[l[i]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[l[i]+"CancelAnimationFrame"]||window[l[i]+"CancelRequestAnimationFrame"]
...
var u=s*i.length,c=i.length
e.strokeStyle="black",e.lineWidth=1,e.beginPath(),e.moveTo(TidePull.leftMarg+1,n-4*i[0].pred*t/d),j=0,e.fillStyle="#a0abb6"
for(var p=0;u>p;p++)e.lineTo(a/c*j+TidePull.leftMarg+1,n-4*i[p].pred*t/d),e.stroke(),e.fillRect(a/c*j+TidePull.leftMarg+1,n-4*i[p].pred*t/d,1,4*i[p].pred*t/d-1),j++
TidePull.labelAxis(e,l,i,o,r,t,d,n,a)},TidePull.labelAxis=function(e,l,i,t,a,n,d,o,r){e.fillStyle="#092643",e.font="17px Sans Serif",e.fillText("Feet",1.8*TidePull.leftMarg,2.5*TidePull.topMarg),e.font="14px Sans Serif",e.textAlign="right",e.strokeStyle="black"
for(var s=0;t>=s;s+=.25)e.fillText(s,TidePull.leftMarg-8,o-4*s*n/d+.2*TidePull.topMarg),e.beginPath(),e.moveTo(TidePull.leftMarg,o-4*s*n/d),e.lineTo(TidePull.leftMarg+.1*TidePull.leftMarg,o-4*s*n/d),e.stroke()
for(var u=a;0>u;u+=.25)e.fillText(u,TidePull.leftMarg-8,o-4*u*n/d),e.beginPath(),e.moveTo(TidePull.leftMarg,o-4*u*n/d),e.lineTo(TidePull.leftMarg+.1*TidePull.leftMarg,o-4*u*n/d),e.stroke()
TidePull.timeAxis(e,l,r,o,i,n)},TidePull.timeAxis=function(e,l,i,t,a,n){if(240==a.length){e.font="12px Sans Serif",e.strokeStyle="#092643",e.fillStyle="#092643",e.textAlign="center"
for(var d=1;12>d;d++)e.beginPath(),e.moveTo(TidePull.leftMarg+d*i/12,t),e.lineTo(TidePull.leftMarg+.32*TidePull.leftMarg+d*i/12,t+.6*TidePull.topMarg),e.stroke(),e.closePath(),e.beginPath(),e.arc(TidePull.leftMarg+d*i/12,t,3,0,2*Math.PI,!0),e.closePath(),e.fill(),6>d?e.fillText(2*d+"AM",1.6*TidePull.leftMarg+d*i/12,t+1.2*TidePull.topMarg):6==d?e.fillText(2*d+"PM",1.6*TidePull.leftMarg+d*i/12,t+1.2*TidePull.topMarg):e.fillText(d%6*2+"PM",1.6*TidePull.leftMarg+d*i/12,t+1.2*TidePull.topMarg)}else{e.font="12px Sans Serif",e.fillStyle="#092643"
var o=a.length/240
e.textAlign="center"
for(var r=0;o>r;r+=.5)e.beginPath(),e.moveTo(TidePull.leftMarg+r*i/o,t),e.lineTo(TidePull.leftMarg+.2*TidePull.leftMarg+r*i/o,t+.6*TidePull.topMarg),e.stroke(),e.closePath(),e.beginPath(),e.arc(TidePull.leftMarg+r*i/o,t,3,0,2*Math.PI,!0),e.closePath(),e.fill(),r%1==0?e.fillText("12AM",1.5*TidePull.leftMarg+r*i/o,t+1.2*TidePull.topMarg):e.fillText("Noon",1.5*TidePull.leftMarg+r*i/o,t+1.2*TidePull.topMarg)}}
