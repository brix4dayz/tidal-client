function map(){var e={lat:30.220552,lng:-91.380674},t=new google.maps.Map(document.getElementById("map"),{zoom:7,center:e,streetViewControl:!1})
$.getJSON(SERVER+"/locations?state="+STATE,function(e){coordinates={}
var a=null
for(var i in e)a=e[i].name,coordinates[a]={id:e[i].stationId,position:{lat:e[i].lat,lng:e[i].lng}},markers[a]=new google.maps.Marker({position:coordinates[a].position,map:t,title:a,animation:google.maps.Animation.DROP})
