...
e.beginPath(),e.moveTo(leftMarg,topMarg),e.lineTo(leftMarg,chartHeight+topMarg),e.moveTo(leftMarg,l),e.lineTo(chartWidth+leftMarg,l),e.lineWidth=2,e.strokeStyle="#092643",e.stroke(),plotData(e,t,a,chartHeight,chartWidth,l,o,i,n)}function plotData(e,t,a,i,n,o,r,l,s){console.log("Plotting.")
var c=totalTime/PLOT_TIME
c>=1&&(c=1,stop=!0,console.log("Should stop."))
...
e&&(requestTides(options),$("#map").hide(),$("#plotter").show(),$("#returnBtn").show(300))}else alert("TidePlotter\nPlease select a location from the map.")}),$("#returnBtn").on("click",function(){$("#map").show(),$("#plotter").hide(),$("#returnBtn").hide(300)}),$(function(){$("#datepickerA").datepicker()}),$(function(){$("#datepickerB").datepicker()}),$(function(){$("#datepickerC").datepicker()}),function(){for(var e=0,t=["ms","moz","webkit","o",""],a=0;a<t.length&&!window.requestAnimationFrame;++a)window.requestAnimationFrame=window[t[a]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[t[a]+"CancelAnimationFrame"]||window[t[a]+"CancelRequestAnimationFrame"]
