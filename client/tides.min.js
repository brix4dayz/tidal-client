...
i>l&&6>=i-l&&a==t?e=!0:a-1==t&&5>=30-l+i?e=!0:TidePull.alerts.innerHTML=TidePull.alertArray[0]}else TidePull.alerts.innerHTML=TidePull.alertArray[1]
...
e&&(TidePull.alerts.innerHTML="",TidePull.requestTides(),$("#map").hide(),$("#plotter").show(),$("#returnBtn").show(300))}else TidePull.alerts.innerHTML=TidePull.alertArray[3]}),$("#returnBtn").on("click",function(){$("#map").show(),$("#plotter").hide(),$("#returnBtn").hide(300)}),$(function(){$("#datepickerA").datepicker()}),$(function(){$("#datepickerB").datepicker()}),$(function(){$("#datepickerC").datepicker()}),TidePull.mobile?(TidePull.chartHeight=225,TidePull.chartWidth=280,TidePull.labelFont1=10,TidePull.labelFont2=8,TidePull.timeFont=8,TidePull.Yfact=2):(TidePull.chartHeight=365,TidePull.chartWidth=490,TidePull.labelFont1=15,TidePull.labelFont2=14,TidePull.timeFont=12,TidePull.Yfact=6),TidePull.leftMarg=.0714*TidePull.chartWidth,TidePull.topMarg=TidePull.chartHeight/18,TidePull.clearHeight=TidePull.chartHeight+TidePull.topMarg+20,TidePull.clearWidth=TidePull.chartWidth+TidePull.leftMarg+10,function(){for(var e=0,l=["ms","moz","webkit","o",""],i=0;i<l.length&&!window.requestAnimationFrame;++i)window.requestAnimationFrame=window[l[i]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[l[i]+"CancelAnimationFrame"]||window[l[i]+"CancelRequestAnimationFrame"]
window.requestAnimationFrame||(window.requestAnimationFrame=function(l,i){var t=(new Date).getTime(),a=Math.max(0,16-(t-e)),d=window.setTimeout(function(){l(t+a)},a)
return e=t+a,d}),window.cancelAnimationFrame||(window.cancelAnimationFrame=function(e){clearTimeout(e)})}(),function(){function e(){var e=Date.now()
...
TidePull.drawAxis(e,l,t,a,d)},TidePull.drawAxis=function(e,l,i,t,a){var d=(t-a)/.25,n=.25
...
var r=TidePull.chartHeight*t/(d*n)+TidePull.topMarg
e.beginPath(),e.moveTo(TidePull.leftMarg,TidePull.topMarg),e.lineTo(TidePull.leftMarg,TidePull.chartHeight+TidePull.topMarg),e.moveTo(TidePull.leftMarg,r),e.lineTo(TidePull.chartWidth+TidePull.leftMarg,r),e.lineWidth=2,e.strokeStyle="#092643",e.stroke(),TidePull.plotData(e,l,i,TidePull.chartHeight,TidePull.chartWidth,r,d,t,a,n)},TidePull.plotData=function(e,l,i,t,a,d,n,o,r,u){console.log("Plotting.")
var s=TidePull.totalTime/TidePull.PLOT_TIME
s>=1&&(s=1,TidePull.stop=!0,console.log("Should stop."),240==i.length&&TidePull.highLow(e,i))
var c=s*i.length,p=i.length
e.strokeStyle="black",e.lineWidth=.1,e.beginPath(),e.moveTo(TidePull.leftMarg+1,d-i[0].pred*t/(n*u)),j=0,e.fillStyle="#a0abb6"
for(var T=0;c>T;T++)e.lineTo(a/p*j+TidePull.leftMarg+1,d-i[T].pred*t/(n*u)),e.stroke(),e.fillRect(a/p*j+TidePull.leftMarg+1,d-i[T].pred*t/(n*u),1,i[T].pred*t/(n*u)-1),j++
TidePull.labelAxis(e,l,i,o,r,t,n,d,a,u)},TidePull.labelAxis=function(e,l,i,t,a,d,n,o,r,u){e.fillStyle="#033a0f",e.textAlign="left",e.font=TidePull.labelFont1+"px Sans Serif",e.fillText("Tides in Feet",TidePull.leftMarg+5,.8*TidePull.topMarg),e.font=TidePull.labelFont2+"px Sans Serif",e.textAlign="right",e.strokeStyle="black",e.lineWidth=1
for(var s=0;t>=s;s+=u)e.fillText(s,TidePull.leftMarg-TidePull.Yfact,o-s*d/(n*u)+.2*TidePull.topMarg),e.beginPath(),e.moveTo(TidePull.leftMarg,o-s*d/(n*u)),e.lineTo(TidePull.leftMarg+TidePull.chartWidth,o-s*d/(n*u)),e.stroke()
for(var c=a;0>c;c+=u)e.fillText(c,TidePull.leftMarg-TidePull.Yfact,o-c*d/(n*u)+2),e.beginPath(),e.moveTo(TidePull.leftMarg,o-c*d/(n*u)),e.lineTo(TidePull.leftMarg+TidePull.chartWidth,o-c*d/(n*u)),e.stroke()
TidePull.timeAxis(e,l,r,o,i,d)},TidePull.highLow=function(e,l){for(var i=l[0],t=l[0],a=!1,d=0;d<l.length;d++)l[d].pred>i.pred&&(i=l[d]),0==a&&l[d].pred<t.pred&&(t=l[d]),l[d].pred<0&&(a=!0,l[d].pred>t.pred&&(t=l[d]))
var n=JSON.stringify(i.timeStamp),o=JSON.stringify(t.timeStamp),r="High: "+i.pred+" at "+n.slice(13,18)+"  Low: "+t.pred+" at "+o.slice(13,18)
e.textAlign="right",e.fillStyle="#033a0f",e.font=TidePull.labelFont1+"px Sans Serif",e.fillText(r,TidePull.leftMarg+TidePull.chartWidth,.8*TidePull.topMarg)},TidePull.timeAxis=function(e,l,i,t,a,d){if(240==a.length){e.font=TidePull.timeFont+"px Sans Serif",e.strokeStyle="#092643",e.fillStyle="#033a0f",e.textAlign="center"
for(var n=1;12>n;n++)e.beginPath(),e.moveTo(TidePull.leftMarg+n*i/12,t),e.lineTo(TidePull.leftMarg+.1*TidePull.leftMarg+n*i/12,t+.3*TidePull.topMarg),e.stroke(),e.closePath(),e.beginPath(),e.arc(TidePull.leftMarg+n*i/12,t,3,0,2*Math.PI,!0),e.closePath(),e.fill(),e.beginPath(),e.moveTo(TidePull.leftMarg+n*i/12,TidePull.topMarg),e.lineTo(TidePull.leftMarg+n*i/12,TidePull.topMarg+d),e.stroke(),e.closePath(),6>n?e.fillText(2*n+"AM",1.6*TidePull.leftMarg+n*i/12,t+.8*TidePull.topMarg):6==n?e.fillText(2*n+"PM",1.6*TidePull.leftMarg+n*i/12,t+.8*TidePull.topMarg):e.fillText(n%6*2+"PM",1.6*TidePull.leftMarg+n*i/12,t+.8*TidePull.topMarg)}else{e.font=TidePull.timeFont+2+"px Sans Serif",e.fillStyle="Green"
var o=a.length/240
...
for(var r=0;o>r;r+=.25)r%.5==0&&(e.beginPath(),e.moveTo(TidePull.leftMarg+r*i/o,t),e.lineTo(TidePull.leftMarg+.1*TidePull.leftMarg+r*i/o,t+.3*TidePull.topMarg),e.stroke(),e.closePath(),e.beginPath(),e.arc(TidePull.leftMarg+r*i/o,t,3,0,2*Math.PI,!0),e.closePath(),e.fill()),e.beginPath(),e.moveTo(TidePull.leftMarg+r*i/o,TidePull.topMarg),e.lineTo(TidePull.leftMarg+r*i/o,TidePull.topMarg+TidePull.chartHeight),e.stroke(),e.closePath(),r%1==0?(e.fillText("12AM",1.6*TidePull.leftMarg+r*i/o,t+.8*TidePull.topMarg),0!=r&&e.fillText("Day"+(r+1),1.6*TidePull.leftMarg+r*i/o,t-.3*TidePull.topMarg)):r%.5==0&&r%1!=0&&e.fillText("Noon",1.6*TidePull.leftMarg+r*i/o,t+.8*TidePull.topMarg)}e.beginPath(),e.moveTo(TidePull.leftMarg+TidePull.chartWidth,TidePull.topMarg),e.lineTo(TidePull.leftMarg+TidePull.chartWidth,TidePull.topMarg+TidePull.chartHeight),e.stroke(),e.closePath()},$("body").append('  <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBpN0l_qaCwhVFOKjFIHDuEgtlOkrlFixQ&signed_in=true&callback=map">  </script>')
