...
e&&(TidePull.alerts.innerHTML="",TidePull.requestTides(),$("#map").hide(),$("#plotter").show(),$("#returnBtn").show(300))}else TidePull.alerts.innerHTML=TidePull.alertArray[3]}),$("#returnBtn").on("click",function(){$("#map").show(),$("#plotter").hide(),$("#returnBtn").hide(300)}),$(function(){$("#datepickerA").datepicker()}),$(function(){$("#datepickerB").datepicker()}),$(function(){$("#datepickerC").datepicker()}),TidePull.mobile?(TidePull.chartHeight=225,TidePull.chartWidth=280,TidePull.labelFont1=10,TidePull.labelFont2=8,TidePull.timeFont=8,TidePull.Yfact=2):(TidePull.chartHeight=365,TidePull.chartWidth=490,TidePull.labelFont1=15,TidePull.labelFont2=14,TidePull.timeFont=12,TidePull.Yfact=6),TidePull.leftMarg=.0714*TidePull.chartWidth,TidePull.topMarg=TidePull.chartHeight/18,TidePull.clearHeight=TidePull.chartHeight+TidePull.topMarg,TidePull.clearWidth=TidePull.chartWidth+TidePull.leftMarg,function(){for(var e=0,l=["ms","moz","webkit","o",""],i=0;i<l.length&&!window.requestAnimationFrame;++i)window.requestAnimationFrame=window[l[i]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[l[i]+"CancelAnimationFrame"]||window[l[i]+"CancelRequestAnimationFrame"]
...
TidePull.labelAxis(e,l,i,o,r,t,d,n,a)},TidePull.labelAxis=function(e,l,i,t,a,n,d,o,r){e.fillStyle="#092643",e.font=TidePull.labelFont1+"px Sans Serif",e.fillText("Tides in Feet",2.5*TidePull.leftMarg,2*TidePull.topMarg),e.font=TidePull.labelFont2+"px Sans Serif",e.textAlign="right",e.strokeStyle="black",e.lineWidth=1
for(var u=0;t>=u;u+=.25)e.fillText(u,TidePull.leftMarg-TidePull.Yfact,o-4*u*n/d+.2*TidePull.topMarg),e.beginPath(),e.moveTo(TidePull.leftMarg,o-4*u*n/d),e.lineTo(TidePull.leftMarg+.1*TidePull.leftMarg,o-4*u*n/d),e.stroke()
for(var s=a;0>s;s+=.25)e.fillText(s,TidePull.leftMarg-TidePull.Yfact,o-4*s*n/d),e.beginPath(),e.moveTo(TidePull.leftMarg,o-4*s*n/d),e.lineTo(TidePull.leftMarg+.1*TidePull.leftMarg,o-4*s*n/d),e.stroke()
